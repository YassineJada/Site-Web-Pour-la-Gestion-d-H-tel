...
$CIN = $_POST["CIN"];
 ...
 $msg="";
  ...
  {
   $cin2=$_SESSION["CIN"];
   $reponse = $sqldt->query("UPDATE client SET CIN='$CIN',Nom='$Nom',Prénom='$Prénom',Date_Naissance='$Date_Naissance',Adresse='$Adresse',Télé=$Télé,email='$email',genre='$genre',username='$username',mdp='$mdp' WHERE  CIN='$cin2' ");
   $_SESSION["CIN"] = $CIN;

 }else
  {
    $erreur = "Please check passwords ";
...
<link href="../style/change.css" rel="stylesheet">
...
<section id="sign">
<div class="hh">
  <h1 class="Mo">Modifier vos information</h1>
</div>
...
if(isset($erreur)){
 ...
 ?></h4>
    ...
    <form class="row g-3" method="POST" action="modification.php">
  <div class="col-md-4">
...
<div class=" col-md-4">
  ...
  <div class="  col-md-4">
    <label for="validationDefault01" class="confirmer form-label">Confirmer le Mot de passe</label>
  ...
  <div class=" btn2 col-12 env">
    <button class="btn3 btn-primary" type="submit" name="sbmt">Enregistrer</button>
  </div>
</form>
</section>
</body>
